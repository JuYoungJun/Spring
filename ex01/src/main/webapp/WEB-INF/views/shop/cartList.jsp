					...
					<ul>
						...
						<c:forEach items="${cartList}" var="cartList">
							<li>
								...
								<div class="gdsInfo">
									<p>
										<span>상품명 ${cartList.gdsName}<br /> <span>개당 가격
												<fmt:formatNumber pattern="###,###,###"
													value="${cartList.gdsPrice}" /> 원<br /> <span>구입
													수량 ${cartList.cartStock} 개<br /> <span>최종 가격 <fmt:formatNumber
															pattern="###,###,###"
							...
							<div class="inputArea">
								...
								<p>
									<input type="text" name="userAddr1" id="sample2_address"
										...
										name="userAddr2" id="sample2_detailAddress" placeholder="상세주소">
