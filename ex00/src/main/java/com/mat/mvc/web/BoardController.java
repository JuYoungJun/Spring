...
public class BoardController {
	...
	// 게시물 작성 (더미 늘떄 쓴거 @RequestParam("title") String title, @RequestParam("content") String content)
...
//	}
	...
	@RequestMapping(value = "/deleteReply", method = RequestMethod.GET)
	public String deleteReply(@RequestParam("rno") int rno, @RequestParam("bno") int bno, HttpSession session, RedirectAttributes rttr) throws Exception {
	    MemberVO member = (MemberVO) session.getAttribute("member");
